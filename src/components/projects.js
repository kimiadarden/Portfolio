          ...
          >
            ...
            <ReactCardFlip isFlipped={view1} flipDirection="horizontal">
              ...
              <div className="reverse" key="back">
                <h1>
                A simple, streamlined, and user-friendly web application that allows restaurant owners and staff to build their custom restaurant layout from scratch, assign customers to tables, and track those customers' meals from start to finish.
                </h1>
            ...
            <div className="options">
              ...
              <div>
                <a href="https://guarded-stream-41487.herokuapp.com/" target='new'>
...
{/*########################################################### Project 2 starts here */}
          ...
          >
            ...
            <ReactCardFlip isFlipped={view2} flipDirection="horizontal">
              ...
              <div className="reverse" key="back">
                <h1>
                A game-finding application that will provide you with a wish list of pertinent games to play based on provided criteria. </h1>
            ...
            <div className="options">
              ...
              <div>
                <a href="https://kevin-salamon.github.io/Game-Found/" target='new'>
                  Launch <FontAwesomeIcon icon={faPlayCircle} />
                </a>
              </div>
              <div>
                <a href="https://github.com/kimiadarden/Game-Found" target='new'>
                  Source
                  <FontAwesomeIcon icon={faGithub} />
                </a>
              </div>
...
{/*########################################################### Project 3 starts here */}
          ...
          >
            ...
            <ReactCardFlip isFlipped={view3} flipDirection="horizontal">
              ...
              <div className="reverse" key="back">
                <h1>
                An application that utilizes the Google Book API to search for books and save it to user's favorite list. 
                </h1>
                <h2>Developed with React Js</h2>
              </div>
            </ReactCardFlip>
...
{/* ##########################################################Project 4 starts here */}
          ...
          >
            ...
            <ReactCardFlip isFlipped={view4} flipDirection="horizontal">
              ...
              <div className="reverse" key="back">
                <h1>
                An application to Sort and filter through the Employee directory in order to find the relative information regarding each employee.                </h1>
            ...
            <div className="options">
              ...
              <div>
                <a href="https://pure-reaches-34018.herokuapp.com/" target='new'>
                  Launch <FontAwesomeIcon icon={faPlayCircle} />
                </a>
              </div>
              <div>
                <a href="https://github.com/kimiadarden/Employee-Directory" target='new'>
                  Source
                  <FontAwesomeIcon icon={faGithub} />
                </a>
              </div>
